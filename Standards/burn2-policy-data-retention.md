...
Any questions in relation to this Policy should be referred to  in the first instance, DDDD via email at EEEE.
...
* FFFF is committed to ensuring that all Processing of Personal Data carried out by us and/or our agents, sub-contractors, consultants, employees, or others working on our behalf is carried out in compliance with UK Data Protection Laws. As such, we confirm that:
...
FFFF’s Retention Periods are set out in the schedule to this Policy titled ‘Schedule&nbsp;- Retention Periods’.

The Retention Periods apply however the [Participant] Personal Data is held by us (e.g. whatever its location or format).

## Dealing with Personal Data that is No Longer Needed

All [Participant] Personal Data that is no longer needed in any way must be either deleted (i.e. erased) or anonymised.

Deletion of [Participant] Personal Data held electronically entails this data being permanently deleted as far as is technologically possible. This means that the Team Member carrying out the deletion must ensure that, after deletion, it is beyond use (i.e. they must ensure that, if any traces remain, these traces cannot identify the Data Subject).[DATA CONTROLLER] The Team Member carrying out the deletion should ensure that:
...
Deletion of [Participant] Personal Data held in hard copy entails destruction of this data to the extent that it is beyond use (e.g. so that it cannot be reassembled or read).

Anonymisation entails [Participant] Personal Data being altered into a form that does not allow identification of the Data Subject in any way (i.e. so that the information no longer constitutes Personal Data and is no longer covered by UK Data Protection Laws). Anonymisation may be carried out as an alternative to deletion when useful for the Organisation and appropriate (e.g. for the purposes of carrying out statistical analysis with a large, anonymous dataset).

If a Team Member needs to delete or anonymise [Participant] Personal Data and they are uncertain as to how to appropriately do so, they should contact [DATA CONTROLLER] via email at [CONTROLLER EMAIL] or Notecard in-world for assistance.

## Responsibility

Day-to-day responsibility for monitoring compliance with this Policy, for setting, evaluating, and adapting data retention practices and this Policy, and for setting, evaluating, and adapting Retention Periods, sits with [DATA CONTROLLER].

All individuals working for or acting on behalf of  at all levels, including Leads, Co-Leads and Volunteers (collectively ‘Team Members’) should follow this Policy in relation to any [Participant] Personal Data that they Process. If they have any questions or concerns related to this Policy and their data storage obligations, they should contact [DATA CONTROLLER] via email at [CONTROLLER EMAIL] or Notecard in-world.
...
Any changes to the Retention Periods will be made in compliance with the law and a new justification will be provided for each new Retention Period set. Any such changes will be communicated to relevant Team Members in a timely manner to ensure that practices are adapted accordingly.

Retention Periods will be reviewed by  (or somebody who  has assigned to review the Retention Periods on their behalf and subject to their approval) at least once every [TIME PERIOD], to ensure that these Retention Periods are still reasonable with regard to any changes to the Personal Data held and to any new laws or guidance relevant to a given Retention Period.
